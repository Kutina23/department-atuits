...
const seedDatabase = async () => {
    try {
        ...
        // Create HOD
        const hodPassword = await bcryptjs_1.default.hash('hod123', 10);
        await User_1.User.create({
        ...
        const student1 = await User_1.User.create({
            name: 'John Doe',
        ...
        // Create sample dues
        const due1 = await Due_1.Due.create({
            title: 'Semester Fees',
            amount: 500,
            level: 'ICT 200',
        ...
        const due2 = await Due_1.Due.create({
            title: 'Lab Fees',
            amount: 150,
            level: 'ICT 200',
            academic_year: '2024/2025',
        ...
        const due3 = await Due_1.Due.create({
            title: 'Semester Fees',
            amount: 600,
            level: 'ICT 300',
            academic_year: '2024/2025',
        ...
        const due4 = await Due_1.Due.create({
            title: 'Project Fees',
            amount: 200,
            level: 'ICT 300',
            academic_year: '2024/2025',
